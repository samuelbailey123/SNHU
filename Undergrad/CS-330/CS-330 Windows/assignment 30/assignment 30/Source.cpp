...
namespace
{
    const char* const WINDOW_TITLE = "Assignment 3-3"; // Macro for window title
...
void URender()
{
    ...
    glm::mat4 rotation = glm::rotate(0.2f, glm::vec3(10.0, 10.0f, 1.0f));
...
void UCreateMesh(GLMesh& mesh)
{
    ...
    GLfloat verts[] = {
        ...
        //triangle 1
        // main triangle / middle / right side
        0.0f, 1.0f, .0f,         1.0f, 1.0f, 1.0f, 1.0f,
