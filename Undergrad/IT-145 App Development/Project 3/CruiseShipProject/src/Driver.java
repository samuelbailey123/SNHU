...
public class Driver {
        ...
        while (choice != "x"){
            ...
            switch(choice){
                ...
                case "B": printShipList("active");
                    break;
                case "C": printCruiseList("full");
                    break;
                case "D": printCruiseList("list");
                    break;
                case "E": printCruiseList("details");
                    break;
                case "F": printPassengerList();
                    break;
                case "x": System.exit(0);
                default: System.out.println("Invalid Menu Selection. Select Again...\n");
                    break;
            }
        }
    ...
    public static void printShipList(String listType) {
        ...
        if (shipList.get(5).equals(true)){
            System.out.println(shipList.get(5));
        }
        System.out.println(shipList.get(0) + "  " + shipList.get(1) + "\t"+ shipList.get(2)+ "\t"+shipList.get(3) + "\t"+shipList.get(4) + "\t" + shipList.get(5));
    ...
    public static void addShip() {
        ...
        System.out.println("Room Balcany: ");
        int newRoomBalcany = newShipInput.nextInt();
        System.out.println("Room Ocean View: ");
        int newRoomOceanView = newShipInput.nextInt();
        System.out.println("Room Suite: ");
        int newRoomSuite = newShipInput.nextInt();
        System.out.println("Room Interior: ");
        int newRoomInterior = newShipInput.nextInt();
        System.out.println("Is the ship in service? ");
        boolean newInService = newShipInput.nextBoolean();
        Ship newShip = new Ship(newShipName,newRoomBalcany,newRoomOceanView,newRoomSuite,newRoomInterior,newInService);
        shipList.add(newShip);
    ...
    public static void addCruise() {
        ...
        System.out.println("What is the cruise ship name: ");
        String newCruiseShipName = newCruiseInput.nextLine();

        System.out.println("What departure port: ");
        String newDeparturePort = newCruiseInput.nextLine();

        System.out.println("What is the destination: ");
        String newDeparture = newCruiseInput.nextLine();

        System.out.println("What is the return port: ");
        String newReturnPort = newCruiseInput.nextLine();
        
        Cruise newCruise = new Cruise(newCruiseName,newCruiseShipName,newDeparturePort,newDeparture,newReturnPort);
        cruiseList.add(newCruise);
